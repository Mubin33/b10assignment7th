    ...
    return (
        <>
            <div className="  mt-3 rounded-xl bg-black ">
                ...
                <div className="text-white text-center space-y-3 md:space-y-4 absolute top-28 lg:top-40 left-0 lg:left-64 ">
                    <img className="md:w-44 w-28 mx-auto" src={banner} alt="" />
